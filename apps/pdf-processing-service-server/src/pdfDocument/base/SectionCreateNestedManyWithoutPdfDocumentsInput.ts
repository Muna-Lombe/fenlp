...
@InputType()
class SectionCreateNestedManyWithoutPdfDocumentsInput {
...
export { SectionCreateNestedManyWithoutPdfDocumentsInput as SectionCreateNestedManyWithoutPdfDocumentsInput };
