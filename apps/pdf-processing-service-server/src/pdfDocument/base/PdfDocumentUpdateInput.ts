...
class PdfDocumentUpdateInput {
  ...
  @ApiProperty({
    required: false,
    type: () => SectionUpdateManyWithoutPdfDocumentsInput,
  })
  @ValidateNested()
  @Type(() => SectionUpdateManyWithoutPdfDocumentsInput)
  @IsOptional()
  @Field(() => SectionUpdateManyWithoutPdfDocumentsInput, {
    nullable: true,
  })
...
export { PdfDocumentUpdateInput as PdfDocumentUpdateInput };
