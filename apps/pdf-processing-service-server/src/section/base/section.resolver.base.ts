...
import { PdfDocument } from "../../pdfDocument/base/PdfDocument";
...
export class SectionResolverBase {
  ...
  async createSection(
    ...
    return await this.service.createSection({
      ...
      data: {
        ...
        pdfDocument: args.data.pdfDocument
          ? {
              connect: args.data.pdfDocument,
            }
          : undefined,
      },
    });
  ...
  @graphql.ResolveField(() => PdfDocument, {
    nullable: true,
    name: "pdfDocument",
  })
  async getPdfDocument(
    ...
    const result = await this.service.getPdfDocument(parent.id);
